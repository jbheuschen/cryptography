...
/*:
 ...
 As to the UI, I'm not going too much into details. I will, however, pursue a horizontally split interface, divided into two independent chat windows (so that the upper one can chat with the lower one).
