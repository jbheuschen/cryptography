...
/*:
 ...
 For this we'll use _SwiftUI_ and _CryptoKit_. As we do not have any server infrastructure, we're going to imitate the public key exchange through a helper class. The messages themselves are going to be sent via the _NotificationCenter_.
