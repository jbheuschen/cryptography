...
/*:
 As you can see, this is not really a  "swifty" way of dealing with cryptography. CommonCrypto often requires us to deal with unsafe pointers, manually release objects in defer-clauses, and so on. In my opinion, it's therefore in our interest to use CryptoKit whenever possible.
...
func generateAndStoreRSAKey() throws -> SecKey {
    let keyTag = "de.fheuschen.wwdc21.sss.Cryptography".data(using: .utf8)!
